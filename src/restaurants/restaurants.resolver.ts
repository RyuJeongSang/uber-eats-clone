...
export class RestaurantsResolver {
  ...
  @Role(['Owner'])
  myRestaurants(@AuthUser() owner: User): Promise<SearchRestaurantsOutput> {
  ...
  restaurantsList(
    ...
    return this.restaurantService.restaurantsList(restaurantsInput);
  }
...
export class CategoryResolver {
  ...
  findCategory(
    ...
    return this.restaurantService.findCategory(categoryInput);
  }
}
...
export class DishResolver {
  ...
  createDish(
    @AuthUser() owner: User,
    @Args('input') createDishiInput: CreateDishInput,
  ): Promise<CreateDishOutput> {
    return this.restaurantService.createDish(owner, createDishiInput);
  }
